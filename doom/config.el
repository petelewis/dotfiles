...
(setq
  ...
  doom-font (font-spec :family "Inconsolata Nerd Font Mono" :size 24)
...
(setq projectile-project-search-path '("~/Dropbox/Research/Writings/WIP/" "~/Dropbox/Research/Talks/" "~/Dropbox/src" "~/Dropbox/sites"))
